...
## P1-P4 containment and accounting corrections before renewed review
...
The new hostile-boundary regressions use mocked no-target processes only. They prove the nested descriptor boundary, nonzero/timeout completion gate, inspection bypass, malformed/incomplete-analysis closure, invalid skipped escape/UTF-8/numeric rejection, allowlisted hostile-summary rejection, fixed-wrapper identity despite a shadowed `PATH`, and consumed-attempt retry denial. The following digests identify the corrected review artifact, not a second producer attempt.
...
| `0003/claude_progressive_probe_0003.py` | `d824612cf302fae656ec7ef43d2cecf8eb8d87c59101a30d1b5bd01455003720` | Bounded fail-closed host launcher, wrapper identity, attempt gate, and allowlisted summary admission |
| `0003/runtime/inner_probe_0003.py` | `93366dc2104100f612de6406f71fa7cdca17f9301d116f6f553ff3e20bdb5e99` | Nested-PID in-namespace loopback/control/grammar-complete structural helper |
