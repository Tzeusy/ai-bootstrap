...
## P1-P7 containment, accounting, control-evidence, and analysis-consistency corrections before renewed review
...
The new hostile-boundary regressions use mocked no-target processes only. They prove the nested descriptor boundary, nonzero/timeout completion gate, inspection bypass, malformed/incomplete-analysis closure, invalid skipped escape/UTF-8/numeric rejection, signed-64 source-counter admission/rejection, host-derived confirmation versus forged zero/control/inconsistent or inner-classifier-unreachable aggregate evidence, allowlisted hostile-summary rejection, fixed-wrapper identity despite a shadowed `PATH`, and consumed-attempt retry denial. The following digests identify the corrected review artifact, not a second producer attempt.
...
| `0003/claude_progressive_probe_0003.py` | `1973fef9e41ffd1aa03d89d7e48a12d79ad668cd071c02745eb2a1c882b783a8` | Bounded fail-closed host launcher, source-counter range, semantic control-evidence and inner-analysis reachability binding, wrapper identity, attempt gate, and allowlisted summary admission |
| `0003/runtime/inner_probe_0003.py` | `bd88c94a2f223774cd5376e6a681e868d4dfc89c104a53ad657e4e38e8f10a44` | Nested-PID in-namespace loopback/control/grammar-complete, signed-64-bounded structural helper |
