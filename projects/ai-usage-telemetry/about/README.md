...
[Observed by a repository-tree sweep at a named review commit] Capability
specifications are the fifth project-shape pillar and remain absent while no
`openspec/` path exists. Observable requirements and WHEN/THEN
