...
- **THEN** the post-migration oracle preserves every binding digest, keeps the never-bound sink checkpoint-free, and returns byte-equal component, aggregate, health, and view semantics
