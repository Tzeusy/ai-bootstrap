...
- **AND** cross-kind sequence reuse or an orphan/mismatched child fails at transaction commit
...
- **AND** a fixture with cross-kind sequence reuse fails all-old-or-all-new without changing any row or checkpoint
