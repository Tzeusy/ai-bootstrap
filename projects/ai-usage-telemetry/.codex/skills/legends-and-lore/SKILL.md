...
description: >
  Load AI Usage Telemetry design contracts before changing adapters,
  normalization, identity, reconciliation, the ledger, queries, sinks, runtime
  boundaries, or release-profile mechanics. Use when implementation or review
  needs the authoritative HOW and its accepted evidence.
---
...
| Document | Read when... |
|---|---|
| [Pillar index](../../../about/legends-and-lore/README.md) | Orienting to current authority and reading order |
| [RFC 0001](../../../about/legends-and-lore/rfcs/0001-adapter-ledger-and-sink-contract.md) | Changing any load-bearing adapter, domain, ledger, query, sink, or runtime contract |
...
`/spec-and-spine` for observable requirements.
