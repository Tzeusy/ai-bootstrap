...
rows retain Decision 0002 acceptance; Decision 0003 accepts four exact
replacement rows, so all eleven current rows are accepted. Load the smallest
owner, and never treat accepted contract bytes as runtime or release evidence.
