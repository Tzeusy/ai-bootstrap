...
2. Choose a theme.
3. Use colors from that theme file.
4. Set `appState.excalidrawDiagramTheme` in the document.
...
```json
{
  ...
  "width": 0,
  "height": 200,
  "strokeColor": "<theme structural stroke>",
  "backgroundColor": "transparent",
  "fillStyle": "solid",
  "strokeWidth": 2,
  "strokeStyle": "solid",
