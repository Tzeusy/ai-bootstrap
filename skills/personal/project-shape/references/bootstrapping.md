...
4. **Default engineering biases** — Does the project prefer cleanup over internal compatibility cruft, simplicity over cleverness, diagnosable failure paths, and durable fixes over expedient patches?
