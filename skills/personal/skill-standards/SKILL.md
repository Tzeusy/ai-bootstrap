...
1. Run the mechanical audit first — it checks frontmatter, name/description
   limits, metadata fields, link integrity, orphaned support files, PEP 723
   compliance of Python helpers, adapter YAML, and superskill layout:
