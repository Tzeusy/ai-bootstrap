...
This file was extracted from `.gemini/GEMINI.md` to keep the main directive
file thin. These guides are Gemini-agent-scoped reference material for
making technology and architectural decisions on user projects. They are not
canonical doctrine for the `ai-bootstrap` repository itself.

Consult the relevant section only — do not load the full file into context
at once.

## Index

- [UI/UX Design](#tech_guiui_ux_design)
- [Frontend Architecture](#tech_guidefrontend_architecture)
- [Backend Architecture](#tech_guidebackend_architecture)
- [Local Development Setup](#tech_guidelocal_development_setup)
- [Code Quality and Dependencies](#tech_guidecode_quality_and_dependencies)
- [Testing Strategy](#tech_guidetesting_strategy)
- [Database Interaction](#tech_guidedatabase_interaction)
- [Cloud Platform Overview](#tech_guidecloud_platform_overview)
- [Containerization and Deployment](#tech_guidecontainerization_and_deployment)
- [CI/CD Pipeline](#tech_guideci_cd_pipeline)
- [Cloud Database and Storage](#tech_guidecloud_database_and_storage)
- [Production Readiness](#tech_guideproduction_readiness)
- [AI/ML Integration](#tech_guideai_ml_integration)
- [Graphics and Visualization](#tech_guidegraphics_and_visualization)
- [Data Analysis and Science](#tech_guidedata_analysis_and_science)
