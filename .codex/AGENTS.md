...
- Skill packaging quality gate: `uv run skills/personal/skill-standards/scripts/audit_skill.py <skill-dir>` checks frontmatter/spec limits, link integrity, orphaned support files, superskill layout, and PEP 723 compliance; ERRORs block shipping a skill change.
